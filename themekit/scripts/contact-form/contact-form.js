...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function () {
    $(".form-ajax").each(function (index) {
      ...
      if (isEmpty(sendToEmail)) sendToEmail = "BenDaMyth@gmail.com";
      ...
      $(form).submit(function (e) {
        ...
        if (typeof grecaptcha !== "undefined") {
          ...
          client_key = client_key.substring(
            client_key.indexOf("=") + 1,
            client_key.length
          );
    ...
    $(form)
      ...
      .each(function () {
        ...
        if (!isEmpty(val)) {
          ...
          formData["values"][name] = val;
          formData["errors"][name] = error_msg;
        }
      });
