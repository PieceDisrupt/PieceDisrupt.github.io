...
(function ($) {
  ...
  $.fn.initSlider = function () {
    ...
    if ($.isFunction($.fn.renderLoadedImgs)) {
      $(this).find("li > *:not(img)").renderLoadedImgs();
    }
    if (!isEmpty(anima)) {
  ...
  $.fn.renderSlider = function (id, external_classes, attributes) {
    ...
    if (!isEmpty(options) && options.indexOf("arrows:true") > -1) {
      arrows =
        '<div class="glide__arrows" data-glide-el="controls"><button class="glide__arrow glide__arrow--left" data-glide-dir="<"></button><button class="glide__arrow glide__arrow--right" data-glide-dir=">"></button></div>';
    }
    ...
    if (!isEmpty(options)) {
      ...
      if (
        options.indexOf("controls:out") > -1 ||
        options.indexOf("controls:true") > -1
      ) {
    ...
    $(this).replaceWith(
      "<div" +
        ...
        trigger +
        atts +
        '><div data-glide-el="track" class="glide__track"><ul class="glide__slides' +
        external_classes +
        '"' +
        attributes +
        ">" +
